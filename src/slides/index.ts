...
export const SLIDES_REGISTRY: SlideConfig[] = [
  ...
  { id: 's19', number: 22, title: 'Výstupní evaluace', chapter: 'Evaluace 2', component: Slide19_Poll2Evaluation },
  { id: 's20', number: 23, title: 'Závěr a poděkování', chapter: 'Závěr', component: Slide20_Conclusion },
];
