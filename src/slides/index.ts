...
export const SLIDES_REGISTRY: SlideConfig[] = [
  { id: 's0', number: 0, title: 'Úvodní strana: Revize ŠVP GML', chapter: 'Úvod', component: Slide00_Title },
  { id: 's1b', number: 1, title: 'Harmonogram setkání', chapter: 'Úvod', component: Slide01b_Schedule },
  ...
  { id: 's3', number: 4, title: 'Záplava pojmů nového RVP', chapter: 'Kontext & Pojmy', component: Slide03_RvpBuzzwords },
  { id: 's4', number: 5, title: 'Vstupní živá anketa (1/2)', chapter: 'Živá anketa', component: Slide04_Poll1 },
  { id: 's5', number: 6, title: 'Přeformátování obav (Reframing)', chapter: 'Vize & Postoj', component: Slide05_CanvasReframing },
  { id: 's6', number: 7, title: '4 pilíře pro revizi ŠVP', chapter: 'Vize & Postoj', component: Slide06_WhyChange },
  { id: 's7', number: 8, title: 'Společná reflexe: Jaké má být ŠVP?', chapter: 'Vize & Postoj', component: Slide07_Reflection },
  { id: 's8', number: 9, title: 'Cílová skupina ŠVP', chapter: 'Nadaní žáci', component: Slide08_TargetAudience },
  { id: 's9', number: 10, title: 'Specifikum žáků na GML', chapter: 'Nadaní žáci', component: Slide09_GiftedInfographic },
  { id: 's10', number: 11, title: 'Podpora nadání v ŠVP (Checklist)', chapter: 'Nadaní žáci', component: Slide10_GiftedSupport },
  { id: 's11', number: 12, title: 'Stavební kameny nového kurikula', chapter: 'Nový RVP ZV', component: Slide11_KeyChanges },
  { id: 's12b', number: 13, title: 'Interaktivní portál RVP ZV', chapter: 'Nový RVP ZV', component: Slide12b_RvpPortal },
